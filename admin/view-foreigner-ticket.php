                              ...
                              <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 10px"><?php  echo $noadult=$row['NoAdult'];?></td>
                                     <td style="padding-left: 10px">Rs <?php  echo $cup=$row['AdultUnitprice'];?></td>
                                     <td style="padding-left: 10px">Rs <?php  echo $ta=$cup*$noadult;?></td>
                                </tr>
                                <tr>
                                    <th>Number of Chlidren </th>
                                    <td style="padding-left: 10px"><?php  echo $nochild=$row['NoChildren'];?></td>
                                    <td style="padding-left: 10px">Rs <?php  echo $aup=$row['ChildUnitprice'];?></td>
                                     <td style="padding-left: 10px">Rs <?php  echo $tc=$aup*$nochild;?></td>
                                </tr>
     
                                 <tr>
                                    <th style="text-align: center;color: red;font-size: 20px" colspan="3">Total Ticket Price</th>
                                    <td style="padding-left: 10px;">Rs <?php  echo ($ta+$tc);?></td>
                                </tr>
                                </table>
                                    </div>
                                    <?php } ?>
